# This file holds the path to the directory containing geological surveys.

# Instructions:
# Replace the value of the 'directory_path' variable with the actual path to your directory.
